...
class RoleController extends Controller
{
   ...
   //     $this->middleware(['can:roles']);
    ...
    public function index()
    {
        ...
        return view('admin.paginas.roles.index', compact('roles'));
    }


    public function create()
    {
        return view('admin.paginas.roles.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.paginas.roles.show', compact('role'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.paginas.roles.edit', compact('role'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('admin.paginas.roles.index', compact('roles', 'filters'));
    }
}
